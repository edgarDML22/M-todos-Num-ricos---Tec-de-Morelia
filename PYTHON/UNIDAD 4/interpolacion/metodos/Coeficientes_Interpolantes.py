...
def ejecutar_metodo():
    ...
    df = pd.read_csv('C:\\Users\\EDGAR\\Desktop\\EDGAR\\SCHOOL\\TEC DE MORELIA\\TERCER SEMESTRE\\MÉTODOS NUMÉRICOS\\PYTHON\\UNIDAD 4\\interpolacion\\datos\\Datos_Coeficientes_Interpolantes.csv', delimiter=',')
    matrix = df.to_numpy()
...
def main():
    print("Bienvenid@ al método de Coeficientes Interpolantes")
    print("El archivo que contiene los datos tiene el nombre de 'Datos_Coeficientes_Interpolantes.csv'")
